...
const HotelCardWidgetFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_hotelcardwidget_free(ptr >>> 0, 1));

export class HotelCardWidget {

    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        HotelCardWidgetFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_hotelcardwidget_free(ptr, 0);
    }
    /**
     * @param {string} partner_key
     */
    constructor(partner_key) {
        const ptr0 = passStringToWasm0(partner_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.hotelcardwidget_new(ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
        HotelCardWidgetFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    render(container_id) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.hotelcardwidget_render(this.__wbg_ptr, ptr0, len0);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('hotel_card_widget_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
