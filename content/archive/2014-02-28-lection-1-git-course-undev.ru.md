---
title: "Git. Просто Git. Лекция 1. Введение в системы контроля версий"
description: "Первая лекция курса по Git: что такое системы контроля версий, история VCS от RCS до Git, основы работы Git, установка и первичная настройка."
date: 2014-02-09
lastmod: 2026-03-13
draft: false
slug: "lection-1-git-course-undev"
keywords: ["системы контроля версий", "история git", "введение в git", "vcs"]
tags: ["git", "vcs", "archive", "beginner"]
categories: ["archive"]
---

> **Примечание (2026):** Это материалы курса по Git 2014 года. Раздел об установке содержит устаревшие URL — актуальные инструкции читайте в статье «[Установка и настройка Git](/git/nastrojka-git/)». Концептуальные разделы об истории VCS и принципах работы Git актуальны и сегодня.
